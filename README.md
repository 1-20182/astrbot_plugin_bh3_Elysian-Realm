# 适用于astrbot的崩坏3乐土查询插件 (astrbot_plugin_bh3_Elysian-Realm)

适用于 AstrBot 的崩坏3往事乐土攻略查询插件，使用米游社提供的乐土攻略给用户提供攻略支持，并具备自动检测和更新攻略资源的功能。
...
git clone https://github.com/1-20182/astrbot_plugin_bh3_Elysian-Realm.git
```
...
自动更新配置保存在 `data/astrbot_plugin_bh3_Elysian-Realm/auto_update.json`：
...
版本信息保存在 `data/astrbot_plugin_bh3_Elysian-Realm/version.json`：
